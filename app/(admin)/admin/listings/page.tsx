...
export default function AdminListingsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold font-heading">Listing 審核</h1>
      ...
      {isLoading ? (
              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Dialog open={removeId === listing.id} onOpenChange={(open) => { if (!open) setRemoveId(null) }}>
                    ...
                    <DialogContent>
                      <DialogHeader><DialogTitle>駁回 Listing</DialogTitle></DialogHeader>
                      <div className="space-y-3">
                        <div>
                          <Label>駁回原因</Label>
        ...
        <EmptyState icon={Package} title="沒有待審核的 Listing" description="目前沒有需要審核的上架申請" />
      )}
    </div>
  )
}
