...
#### 審核 Threads 社群驗證
1. 進入 `/admin/threads-verification`
2. 查看待審核列表（賣家名稱、Threads 帳號、驗證碼、提交時間）
3. 核准或退回（可附原因）
4. 歷史分頁可查看過往審核紀錄（支援日期篩選）
...
| `/admin/sellers` | 賣家管理 |
| `/admin/reports` | 檢舉管理 |
| `/admin/threads-verification` | Threads 社群驗證審核 |
