  ...
  return (
    <section className="mx-auto max-w-6xl px-3 py-5 md:px-4 md:py-8">
      ...
      <div className="relative">
        <div
          ref={scrollRef}
          className="grid grid-cols-2 gap-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:flex md:gap-4 md:flex-wrap xl:flex-nowrap xl:overflow-x-auto xl:scroll-smooth xl:pb-2 xl:snap-x"
        >
          {children}
        </div>
