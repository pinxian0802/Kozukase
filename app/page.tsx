...
import { Search, ArrowRight, ShoppingBag, Sparkles, Candy, Smartphone, Home, Gamepad2, Diamond, MoreHorizontal } from 'lucide-react'
...
const categories = [
  ...
  { key: 'electronics', label: '3C電器', icon: Smartphone },
  { key: 'lifestyle', label: '生活雜貨', icon: Home },
  { key: 'toys', label: '公仔玩具', icon: Gamepad2 },
  { key: 'limited', label: '限定聯名', icon: Diamond },
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-7xl px-4 py-12">
          <div className="rounded-2xl bg-gradient-to-r from-primary to-primary/80 p-8 md:p-12 text-center text-white">
            <h2 className="font-heading text-2xl font-bold md:text-3xl">成為 Daigo 代購賣家</h2>
